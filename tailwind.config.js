...
export default {
  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        'bg1': "url('@/assets/images/bg/bg1.png')",
        'bg2': "url('@/assets/images/bg/bg2.png')",
        'bg3': "url('@/assets/images/bg/bg3.png')",
        'bg4': "url('@/assets/images/bg/bg4.jpeg')",
        'bg1-clear': "url('@/assets/images/bg/bg1_clear.png')",
        'bg2-clear': "url('@/assets/images/bg/bg2_clear.png')",
        'bg3-clear': "url('@/assets/images/bg/bg3_clear.png')",
        'bg4-clear': "url('@/assets/images/bg/bg4_clear.png')",
        'bg5-clear': "url('@/assets/images/bg/intro_bg.jpg')",
      },
      fontFamily: {
